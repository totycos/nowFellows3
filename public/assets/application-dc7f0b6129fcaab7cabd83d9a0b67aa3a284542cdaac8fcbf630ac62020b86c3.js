...
$(function() {
    ...
    /*
    sport_tree.progress("no");
    sport_tree.display_html();
    display("info", "Is end " + sport_tree.is_end());
    display("info", "Result: " + sport_tree.get_result());
    sport_tree.display_status();
    
    sport_tree.progress("yes");
    sport_tree.display_html();
    ...
    */
    /*
    // Test push choice into sport tree
    sport_tree.push_choice("sport_2", "SPORT 2", "image_choice", "end", "end");
    console.log(sport_tree);
    */
});
